...
{
    class EllipseVectorShapeModel : VectorShapeModel
    {
        ...
        public EllipseVectorShapeModel(double x, double y, double rot, double width, double height, Color color, Layer layer):base(x, y, rot, color, layer)
        {
            this.width = width;
            this.height = height;
        }
